...
export function Footer() {
  return <footer className="site-footer">
    <div className="container footer-grid">
      ...
      <nav aria-label="Footer account information"><h2>Account &amp; Wallet</h2><a href="/shree-win-login/">Login Guide</a><a href="/shree-win-register/">Register Guide</a><a href="/shree-win-deposit/">Deposit Guide</a><a href="/shree-win-withdrawal/">Withdrawal Guide</a><a href="/shree-win-gift-code/">Gift Code</a><a href="/shree-win-account-settings/">Account Settings</a><a href="/shree-win-agent/">Agent Work</a></nav>
